...
/**
 * Created by Najib Arbaoui on 27/10/2015.
...
public class ViewWelcome extends Activity {
    ...
    private static String url = "http://132.207.89.27/debut";
    //private static String url = "http://Najib Arbaoui.olympe.in/debut2.txt";
    ...
    /**
     * Fonction pour gerer le code entrer dans la vue de bienvenue
     */
